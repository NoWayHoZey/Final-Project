...
HD_PWD='C:/Users/Eric/CodeProjects/CPE133/7SegmentDriver/7SegmentDriver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SegmentDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SegmentDriver.tcl
