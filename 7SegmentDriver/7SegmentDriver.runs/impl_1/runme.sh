...
HD_PWD='C:/Users/Eric/CodeProjects/CPE133/7SegmentDriver/7SegmentDriver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SegmentDriver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SegmentDriver.tcl -notrace
